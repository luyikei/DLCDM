...
ITEM_NAMES = ["CR002Q01", "CR002Q03", "CR002Q05", "CR013Q01", "CR013Q07", "CR017Q01", "CR017Q04", "CR017Q07"]


class PISA12R(Dataset):

    def __init__(self):
        df = pd.read_csv('datafiles/PISA12R/cleaned.csv')
        ...
        time_vals  = df[time_cols].to_numpy(dtype=float)
